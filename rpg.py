        ...
        for person in all_combatants:
            if person in party and person.hp > 0:
                ...
                while not valid_input:
                    ...
                    if choice == "1":
                        ...
                        if enemies[player_target].hp <= 0:
                            ...
                            print(
                                "{} defeated {}".format(person.name, enemies[player_target].name))
                        ...
                        if(person.mp >= 2):
                            player_target = pick_target(enemies)
                            print(
                                "You cast a ball of magic energy at the beast!")
                ...
                while not valid_target:
                    ...
                    print(
                        "{} attacks {}".format(person.name, party[target].name))
...
def main():
    ...
    if direction == "1":
        ...
        while not back:
            ...
            if player.hp > 0:
                print(
                    "Behind the beast was a dead end. Do you want to turn back?")
                print("1. Yes\n2. No")
                print()
        ...
        print(
            "You discover boundless treasure and will never have to work another day of you life!")
